...
class Product
{
     ...
     *  min = 0.1,
     *  max = 10000,
     *  minMessage = "Le poids minimum en grammes est de {{ limit }} pour valider le produit",
     *  maxMessage = "Le poids maximum en grammes est de {{ limit }} pour valider le produit")
     */
    private $weightInGr;
