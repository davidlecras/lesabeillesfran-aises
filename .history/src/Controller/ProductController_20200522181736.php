...
class ProductController extends AbstractController
{
     ...
     */
    public function newComment(Product $product, Request $request, EntityManagerInterface $em)
    {
        ...
        return $this->redirectToRoute('show_product', ['product' => $product->getId()]);
    }

    /**
     * @Route("/produits/{beekeeper}", name="showAllProducts")
     */
    public function findProductsByBeekeeper(ProductRepository $repo)
    {
        $products = $this->$repo->findProductsByBeekeeper();
        return $this->render('product/products.html.twig', [
            'products' => $products,
        ]);
    }
