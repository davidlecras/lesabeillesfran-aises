...
class BeekeeperController extends AbstractController
{
    ...
    /**
     * @Route("/beekepers/products", name="beekeepers_products")
     */
    public function beekeepersProducts(BeekeeperRepository $beekeperRepo)
    {
        $beekeepers = $beekeperRepo->findBeekeepersProduct();
        return $this->render('beekeeper/products.html.twig', [
            'beekeepersProducts' => $beekeepers,
        ]);
    }
}
